...
if($child instanceof xhp_x__base){
...
abstract class xhp_x__composable_element extends xhp_x__base{
private 
$attributes,
$children;
...
if(xhp_x__base::$ENABLE_VALIDATION){
...
}else if($child instanceof xhp_x__frag){
...
$tag_name=xhp_x__base::element2class($tag_name);
$ret=array();
...
if($child instanceof xhp_x__element){
do {
if(xhp_x__base::$ENABLE_VALIDATION){
$child->validateChildren();
}
$child=$child->render();
}while($child instanceof xhp_x__element);

if(!($child instanceof xhp_x__primitive)){
throw new XHPCoreRenderException($this->children[$ii],$child);
}

if($child instanceof xhp_x__frag){
...
case 2:
if(isset($this->children[$index])&&
!($this->children[$index] instanceof xhp_x__base)){
++$index;
return true;
}
return false;
...
case 3:
return ':'.xhp_x__base::class2element($rule);
...
foreach($this->children as $child){
if($child instanceof xhp_x__base){
$tmp=':'.xhp_x__base::class2element(get_class($child));
 ...
 * from :x:element.
 */
abstract class xhp_x__primitive extends xhp_x__composable_element{
 ...
 * of markup.
 */
abstract class xhp_x__element extends xhp_x__composable_element{
final public function __toString(){
$that=$this;
...
while(($that=$that->render()) instanceof xhp_x__element){
$that->validateChildren();
}


if(!($that instanceof xhp_x__composable_element)){
 ...
 */
class xhp_x__composite extends xhp_x__base{
private 
$parent,
$anchor;

public function __construct(xhp_x__base $parent,xhp_x__base $anchor){
$this->parent=$parent;
$this->anchor=$anchor;
}
 ...
 */
class xhp_x__frag extends xhp_x__primitive{
...
return xhp_x__base::class2element($name);
}
}
}
...
xhp_x__base::class2element(get_class($that)).'` reduced into `'.gettype($rend)."`.\n\n".
$that->source
);
}
}
...
xhp_x__base::class2element(get_class($that))."`, expected `$type`.\n\n".
$that->source
);
}
}
